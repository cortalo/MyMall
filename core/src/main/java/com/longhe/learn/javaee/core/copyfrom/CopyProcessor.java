package com.longhe.learn.javaee.core.copyfrom;
...
@SupportedAnnotationTypes({
        "com.longhe.learn.javaee.core.copyfrom.CopyFrom",
        "com.longhe.learn.javaee.core.copyfrom.CopyFrom.Exclude",
        "com.longhe.learn.javaee.core.copyfrom.CopyFrom.Of",
        "com.longhe.learn.javaee.core.copyfrom.CopyTo",
        "com.longhe.learn.javaee.core.copyfrom.CopyTo.Exclude",
        "com.longhe.learn.javaee.core.copyfrom.CopyTo.Of"
})
...
public class CopyProcessor extends AbstractProcessor {
    ...
    public boolean process(Set<? extends TypeElement> annotations, RoundEnvironment roundEnv) {
        ...
        // 创建Java文件
        JavaFile javaFile = JavaFile.builder("com.longhe.learn.javaee.core.util", typeSpecBuilder.build()).build();
